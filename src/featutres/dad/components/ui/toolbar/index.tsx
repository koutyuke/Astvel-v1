...
const ToolBar: FC = () => (
  <div className="relative">
    <div className="group absolute left-0 top-0 flex h-full w-16 flex-col space-y-2 overflow-auto rounded-md bg-gradient-to-b from-[#22c1c3] to-[#7cff9d] p-2 text-teal-700 shadow-lg duration-200 hover:w-40">
      <ToolTitle />
