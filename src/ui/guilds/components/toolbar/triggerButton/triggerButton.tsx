...
const ToolTriggerButton: FC<Props> = forwardRef<HTMLButtonElement, Props>(({ Icon, title, ...other }, ref) => (
  <button
    type="button"
    ref={ref}
...
ToolTriggerButton.displayName = "toolButton";

export { ToolTriggerButton };
