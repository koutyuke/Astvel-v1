...
const Loading: FC = () => {
  return (
    <div className="flex h-full w-full animate-pulse flex-col space-y-4">
      ...
      <div className="flex grow snap-x snap-mandatory space-x-4 overflow-x-auto px-8 scrollbar-hidden tablet:px-16">
        <div className="w-1/3 min-w-[15rem] snap-center  space-y-4 overflow-hidden rounded-lg border border-gray-500 bg-black-2 p-2.5">
          <div className="box-border w-full items-center space-y-3 rounded-lg border border-gray-500 bg-black-2 p-3">
            <div className="h-6 w-full space-y-2 rounded-lg border border-gray-500 bg-black-3" />
            <div className="box-border h-48 w-full items-center space-y-3 rounded-lg border border-gray-500 bg-black-2 p-3" />
          </div>
        </div>
        <div className=" w-1/3 min-w-[15rem] snap-center  space-y-4 overflow-hidden rounded-lg border border-gray-500 bg-black-2 p-2.5">
        ...
        <div className="w-1/3 min-w-[15rem] snap-center space-y-2 overflow-hidden rounded-lg border border-gray-500 bg-black-2 p-2.5">
          <div className="box-border w-full items-center space-y-3 rounded-lg border border-gray-500 bg-black-2 p-3">
            <div className="h-6 w-full space-y-2 rounded-lg border border-gray-500 bg-black-3" />
            <div className="box-border h-48 w-full space-y-4 rounded-lg border border-gray-500 p-3" />
          </div>
        </div>
      </div>
    </div>
